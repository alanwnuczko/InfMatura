...
window.ALGO_TASKS = [
  ...
  },
  {
    ...
    "difficulty": "easy",
    "ckeSource": "Zadanie 2. · Formuła 2023",
    "description": "<p>Napisz funkcję <code>sito(n)</code>, która za pomocą sita Eratostenesa wyznacza i zwraca posortowaną rosnąco listę wszystkich liczb pierwszych z przedziału <code>[2, n]</code>.</p><p>Algorytm powinien mieć złożoność <strong>O(n log log n)</strong>.</p>",
    "inputDesc": "Liczba całkowita n (n >= 0).",
