...
(function (window: Window, document: Document) {
  ...
  WarpInstance.prototype.init = function () {
    var self = this;
  ...
  WarpInstance.prototype.resize = function () {
  ...
  WarpInstance.prototype.cyclePhrase = function () {
    var self = this;
  ...
  WarpInstance.prototype.render = function () {
    var ctx = this.ctx;
    var dpr = this.dpr;
    var w = this.w;
    var h = this.h;
  ...
  WarpInstance.prototype.destroy = function () {
    if (this.animFrameId) {
